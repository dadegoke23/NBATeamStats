...
from ttu_stat_info import TEAM_NAME_TO_ID
from ttu_stat_info import TEAM_ID_TO_NAME
from ttu_stat_info import TEAM_ID_DATA
from ttu_stat_info import CITY_TO_TEAM
...
DEVELOPER_KEY = " AIzaSyDHoRC7Ad2Csh_DJpX-bgrEO9OOWySk0Y8 "
...
# Reddit API Key
reddit = praw.Reddit(client_id="srY4YhwmzH2_-g",
                     client_secret="2yMiBbxpCCnrER28q8BaaCoZSEw",
                     user_agent="NBA Stats by Jacob Opoku")
...
def index():
    ...
    return render_score_page("index.html", datestring_today, "ttuballstat.com")
